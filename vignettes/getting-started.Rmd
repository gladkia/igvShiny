...
remoteOptions <- parseAndValidateGenomeSpec(
    ...
    stockGenome = FALSE,
    dataMode = "http",
    fasta = file.path(base_url, "ribosomal-RNA-gene.fasta"),
    fastaIndex = file.path(base_url, "ribosomal-RNA-gene.fasta.fai"),
    genomeAnnotation = file.path(base_url, "ribosomal-RNA-gene.gff3")
    )
