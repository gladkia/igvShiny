...
Naming a stock genome means igvShiny fetches nothing itself: the browser reads
the registry entry and streams the sequence from wherever it points. Since
