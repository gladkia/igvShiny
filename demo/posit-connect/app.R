...
#
# This used to be a hand-maintained copy of inst/showcase/igvShinyDemo.R with a
...
# runApp(system.file("showcase", "igvShinyDemo.R", package = "igvShiny")).
#
...
if (!nzchar(app.file))
  stop(sprintf("igvShiny %s ships no showcase/igvShinyDemo.R - bump the pinned SHA in manifest.json",
